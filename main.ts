...
import { CompilerOptions, LANGUAGETYPE } from './Types';
...
function Compiler(Options: CompilerOptions) {
    ...
    fs.writeFileSync(path.normalize(`${CompilerDir}/${filename}`), Options.code.split("\\").join("\\\\"));
